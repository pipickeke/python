...
class Solution:
    ...
    def maxValueOfCoins_2(self, piles:List[List[int]], k:int)->int:
        @cache
        def dfs(i, j):
            if i < 0:
                return 0
    ...
    def maxValueOfCoins_3(self, piles:List[List[int]], k:int)->int:
    ...
    def maxValueOfCoins_4(self, piles:List[List[int]], k:int)->int:
